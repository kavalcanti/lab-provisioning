# Terraform Outputs for make-debian module
# These outputs can be consumed by scripts and Ansible inventory generation
...
output "vm_ip" {
  ...
  value       = try(proxmox_virtual_environment_vm.debian_vm.ipv4_addresses[1][0], "waiting for IP...")
}
